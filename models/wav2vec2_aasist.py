...
class SSLModel(nn.Module):
    def __init__(self):
        """
        Load the pre-trained wav2vec2.0 model (modified by zt: remove fairseq dependency, use torchaudio)
        ...
        self.out_dim = bundle._params["encoder_embed_dim"]
    ...
    def extract_feat(self, input_data):
        ...
        output = self.model.extract_features(input_tmp)[0]
        return output[-1]  # return the last layer output
